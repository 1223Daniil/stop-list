...
JSDoc стоит на публичных кусках, которые шарятся между слоями: UI-кит, Zod-схема стопа, ключи и патч кэша Query, фильтры URL, хуки stop/resume. Внутри экрана и формы отдельных комментариев почти нет, там хватает имён и типов, комментарии на русском для простоты.
